...
void Gy87::calib_gyro(){
  if(not this->gyro_enable) return;
...
void Gy87::save_gyro_calib_param(){
  if(not (
    this->gyro_enable and
    this->flash_initiated and
    this->calibrated
  )) return;
...
void Gy87::load_gyro_calib_param(){
  if(not (this->flash_initiated and this->gyro_enable)) return;
  this->calibrated = true;
  uint8_t buf[sizeof(float)*3];
...
void Gy87::load_acc_calib_param(){
  if(not (this->flash_initiated and this->acc_enable)) return;
  this->calibrated = true;
  uint8_t buf[sizeof(float)*3];
...
void Gy87::load_mag_calib_param(){
  if(not (this->flash_initiated and this->mag_enable)) return;
  this->calibrated = true;
  uint8_t buf[sizeof(float)*3];
...
void Gy87::load_calib_param(){
  this->load_gyro_calib_param();
  this->load_acc_calib_param();
  this->load_mag_calib_param();
}
//-----------------------------------------------------------------------
